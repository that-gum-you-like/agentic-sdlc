...
- [x] **H1** Gates that enforce — review-hook can fail; pattern-hunt no always-pass; alignment real signals; schema-validator fail-closed  · Spec REQ-H1 · M
...
- [x] **H5** No-OpenAI default catalog; gate openai/azure adapters  · REQ-H5 · S
...
- [x] **H8** CI-wired tests for every new module; extend `capability-monitor.mjs` only for uncovered paths (it is already tested)  · REQ-H8 · S
- [x] **H3** Exact-accounting groundwork (feeds P4)  · REQ-H3 · S/M
